...
def main():
    ...
    st.caption("Search using plain English (e.g., 'diabetes', 'life expectancy', 'mortality rate').")
...
"
        ...
        st.warning("No WHO indicators found for that keyword. Try simpler words like 'life', 'mortality', 'cancer'.")
    else:
